...
const PaymentMethodCard = () => {
  return (
    ...
    <div className='row py-5 m-0 d-flex' style={{backgroundColor: "#e76f51", border: "1px" , borderRadius: "15px"}}>
    <div className='heading fs-1 py-2'>
            <h1 style={{color:"#fff"}}>Payment Method</h1>
    </div>
    <hr style={{color:"#e76f51" , width:'100%',}} />
    </div>
